...
@section('main-content')
    <div class="container">
        <div class="row">
            <div class="col-3"></div>
            <div class="col-6">
                <form style="margin-top: 50px;" enctype="multipart/form-data" action="{{ url('/student/update') }}/{{ $student->id }}" method="POST">
                    @csrf
                    <h1>Edit Student</h1>
                    ...
                    <div class="form-group" style="margin-top: 20px;">
                        <input type="file" value="{{ $student->image }}" name="image" id="" placeholder="Enter Mobile Number..." class="form-control">
                    </div>
